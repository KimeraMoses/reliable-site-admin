...
import { getInvoiceById, getUserById } from 'store';
                        ...
                        <div className="users invoice-details">
                            <div className="invoice-Details__left">
                                <div className="flex justify-between items-center">
                                    <h4 className="text-white text-[24px]">Invoice {invoice?.billNo}</h4>
                                    <button className="bg-[#0BB783] rounded-[8px] px-[16px] py-[8px] text-[#fff] mb-0">{t('payNow')}</button>
                                </div>
                                <div className="mt-[40px]">
                                    <h6 className="text-[#474761] text-[14px]">{t('issueDate')}</h6>
                                    <p className="text-[#fff]  text-[14px] mt-[4px]">{moment(invoice?.createdOn).format('DD MMM YYYY')}</p>
                                </div>
                                ...
                                <div className="mt-[40px]">
                                    ...
                                    {
                                        invoice?.billedProductLineItems?.map((data, i) => (
                                            <div key={i}>
                                                <div className="flex items-center justify-between">
                                                    <h6 className="text-[#fff] text-[14px]"><span className="w-[10px] h-[10px] inline-block rounded-[50%] border-2 border-[#F64E60] mr-[5px]"></span>{data?.name}</h6>
                                                    <h6 className="text-[#fff] text-[14px]">${data?.price}</h6>
                                                </div>
                                                <div className="border-dashed border-t-[1px] h-[0px] border-[#323248] mt-[20px] mb-[20px]" ></div>
                                            </div>
                                        ))
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <h6 className="text-[#fff] text-[14px]">${invoice?.subTotal}</h6>
                                    </div>
                                    <div className="border-dashed border-t-[1px] h-[0px] border-[#323248] mt-[20px] mb-[20px]" ></div>
                                    <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <h6 className="text-[#fff] text-[14px]">${invoice?.totalPrice}</h6>
                                    </div>
                                    <div className="border-dashed border-t-[1px] h-[0px] border-[#323248] mt-[20px] mb-[20px]" ></div>
                                </div>
                            </div>
                            <div className="invoice-Details__right p-[40px] bg-[#1A1A27] border-dashed border-[1px] border-[#323248] rounded-[8px]">
                                <button className={`bg-[${statusList(invoice.status)?.bg}] rounded-[8px] px-[8px] py-[4px] text-[10px] text-[${statusList(invoice.status)?.text}] mb-0 uppercase`}>{statusList(invoice.status)?.name}</button>
                                ...
                                <div className="mt-[20px]">
                                    ...
                                    <p className="text-[#fff]  text-[14px] mt-[4px]">--- . <span className="text-[#F64E60] inline-block">---</span></p>
                                </div>
